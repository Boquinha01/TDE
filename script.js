...
function mostrarGrafico(tipoGrafico) {
    ...
    switch(tipoGrafico) {
        ...
        datasets: [{
            ...
            borderWidth: 2,
            data: [57884000, 55544000, 61096000, 7845200] // Dados para as barras
        }]
            };
            config = {
                type: 'bar',
        ...
        datasets: [{
            ...
            borderWidth: 2,
            data: [141435200, 136963304, 157632504, 205606907] // Dados para as barras
        }]
            };
            config = {
                type: 'bar',
...
datasets: [{
    ...
    borderWidth: 1,
    data: [13760000, 41280000, 2844000] // Dados para as barras
}]};
...
datasets: [{
    ...
    borderWidth: 1,
    data: [2624000, 8688000, 35550000, 8682000] // Dados para as barras
}]};
...
datasets: [{
    ...
    borderWidth: 1,
    data: [192000, 264000, 6004000, 54636000] // Dados para as barras
}]
   };
...
datasets: [{
    ...
    borderWidth: 1,
    data: [16000, 2064000, 0, 5767200] // Dados para as barras
}]};
...
datasets: [{
    ...
    borderWidth: 1,
    data: [42656000, 90816000, 7963200] // Dados para as barras
}]};
...
datasets: [{
    ...
    borderWidth: 1,
    data: [8134400, 19113600, 99540000, 10175304] // Dados para as barras
}]};
...
datasets: [{
    ...
    borderWidth: 1,
    data: [595200, 580800, 7963200, 10175304,4182000,1840000] // Dados para as barras
}]
   };
...
datasets: [{
    ...
    borderWidth: 1,
    data: [49000, 4540800, 0, 6765580,63000000,75800000,55660527] // Dados para as barras
}]};


function mostrarMiniatura(id, dados) {
    // Obtém o contêiner da miniatura pelo ID
    ...
    new Chart(canvas, {
        ...
        options: {
            ...
            aspectRatio: 1 // Isso define a proporção de aspecto do gráfico (largura / altura)
        }
    });

    var miniaturas = document.querySelectorAll('.miniatura-container');
    miniaturas.forEach(function(miniatura) {
        miniatura.classList.remove('escondido'); // Remove a classe 'escondido'
    });
}
...
function mostrarGraficos2() {
    ...
    // Mostra os gráficos em miniaturas
